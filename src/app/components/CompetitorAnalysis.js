    ...
    <div className="bg-white rounded-lg shadow-lg p-6 border border-blue-100 hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 shadow-sm">
          ...
          <div className="flex bg-white rounded-lg p-3 shadow-sm border border-blue-200">
            ...
            <span className="text-gray-700 text-sm sm:text-base">{data.pricingStrategy}</span>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 shadow-sm">
          ...
          <div className="flex bg-white rounded-lg p-3 shadow-sm border border-blue-200">
            ...
            <span className="text-gray-700 text-sm sm:text-base">{data.targetMarketAlignment}</span>
          </div>
        </div>
      </div>
    </div>
